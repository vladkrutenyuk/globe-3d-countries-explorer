// Generates src/data/countries.json — a trimmed subset of the REST Countries dataset keyed by ISO alpha-3.
// The public REST Countries API v1–v4 was shut down (v5 requires an API key), so the app imports this file statically.
...
const OUTPUT_PATH = new URL("../src/data/countries.json", import.meta.url);
